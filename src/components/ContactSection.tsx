        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white py-4 px-8 rounded-lg font-semibold hover:bg-secondary transition-all duration-200 transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Reach out to us through any of these channels. Our team is ready to assist you with your real estate needs.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+971XXXXXXXXX" className="text-primary hover:text-secondary transition-colors duration-200">
                    +971 XX XXX XXXX
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Friday - Saturday: By Appointment</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-200">
